      ...
      <div className="mt-1 w-full">
        <div className="flex w-full flex-col gap-2.5 sm:flex-row sm:items-center">
          <Link href={home} className="w-full sm:w-auto">
            <Button
              size="lg"
              className="group relative w-full overflow-hidden bg-white font-semibold text-indigo-700 shadow-pop hover:-translate-y-0.5 active:scale-[0.98] sm:w-auto"
            >
              <span aria-hidden className="animate-sheen pointer-events-none absolute inset-y-0 -left-1/3 w-1/3 bg-gradient-to-r from-transparent via-indigo-200/60 to-transparent" />
