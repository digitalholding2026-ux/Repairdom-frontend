...
export function RewardProgressCard({
  ...
  return (
    <Link href={href} className="block active:scale-[0.99] transition-transform">
      <div className="motion-safe:animate-float-wave-delayed relative overflow-hidden rounded-3xl border border-white/10 bg-[#0F172A]/85 p-5 text-white shadow-float backdrop-blur-sm transform-gpu">
        <div
          aria-hidden
